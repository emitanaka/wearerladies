...
![](figures/day4/non-standard-index-2.png)<!-- -->
...
![](figures/day4/arima-model-1.png)<!-- -->
...
```
    ...
    ## AIC=1772.49   AICc=1772.56   BIC=1803.03
    ## Series: value 
...
```
    ...
    ## AIC=1769.03   AICc=1769.06   BIC=1789.39
    ## Series: value 
    ## Model: ARIMA(1,0,0)(1,0,1)[7] 
    ## 
    ## Coefficients:
